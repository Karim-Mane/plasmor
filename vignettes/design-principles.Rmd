---
title: "Design Principles for {plasmor}"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Design Principles for {plasmor}}
...
This vignette outlines the design decisions that have been taken during the development of the `{plasmor}` R package, and provides some of the reasoning, and possible pros and cons of each decision.
